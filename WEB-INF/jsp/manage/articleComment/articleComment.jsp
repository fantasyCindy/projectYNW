  ...
  <script>
  	$(function(){
  		$('#contentTable').bootstrapTable({
            ...
            height:tableHeight,
            cache: false,
            url: path + '/backArticleComment/list.do',
            striped: true,
            pagination: true,
            pageSize: 50,
  	...
  	function typeFormatter(value,row){
  		if(value ==0){
  			return "<font style='color:red;cursor:pointer;' title='资讯评论'>资讯评论</font>";
  		}else if(value==1){
  			return "<font style='color:green;cursor:pointer;' title='观点评论'>观点评论</font>";
  		}
  		return value;
  	}
   ...
   function deleteRows(){
	   ...
	   showConfirm('确认要删除'+rowDatas.length+'条数据吗？',
		function(){
		   ...
		   $.post(path + '/backArticleComment/doOperateAll.do',{operType:"del",ids:_deleteArr.toString()},function(_backData){
