  ...
  <script>
  	 $(function(){
  		$('#contentTable').bootstrapTable({
          	...
          	height:tableHeight,
          	cache: false,
            url: path + '/video/draftList.htmlx',
            striped: true,
            pagination: true,
            pageSize: 50,
  	...
  	function loadQueryAlbumSelect(){
  	 ...
  	 function operatorFormatter(value,row){
  		 //var detailHtml = "<a class='btn btn-info btn-xs' href='javascript:;' onclick='editModal("+value+");'><i class='fa fa-edit'></i> 修改 </a>";
			        ...
			        <form class="form-inline" id="formId">
					    ...
					    <fieldset>
					      ...
					      <div class="form-group">
						    ...
						    <input type="text" class="form-control" name="title" id="titleInput" placeholder="请输入标题" size="50" data-toggle="tooltip" data-placement="top" title="请输入标题！" style="width:822px;">
						  </div>
