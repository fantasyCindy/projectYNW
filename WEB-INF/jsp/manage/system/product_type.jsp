...
<html lang="zh-CN">
  ...
  <script>
    ...
    function saveOrUpdate(){
	  ...
	  var _params = $('#formId').serialize();
   	  ...
   	  var _postUrl = '/product_type/saveorupdate.do';
  ...
  //  function deletes(){
	 ...
	 //       }
		//    $.post(path + '/product_type/del.do',{ids:_delIdArr.toString()},function(_backData){
		// 	   if("success" == _backData){
		// 		   showOnlyMsg('删除成功！');
	 //   	  	   }else
			    ...
			    <div class="modal-content">
			      <div class="modal-body">
			        <form class="form-inline" id="formId">
			            ...
			            <input type="hidden" id="type_id" name="id" style="display: none;"/>
					    <fieldset>
					      ...
					      <div class="form-group">
						    ...
						    <input type="text" class="form-control" name="type_name" id="nameInput" placeholder="产品类型名称" data-toggle="tooltip" data-placement="top" title="请输入产品类型名称！">
						  </div>
