...
<html lang="zh-CN">
  ...
  <script>
    ...
    function openaddEditModal(_addEditType) {
    	...
    	if('add' == _addEditType){
    		$('#formId fieldset legend').html('新增资金量');
    		$("#id").val("");
    	}else{
    		$('#formId fieldset legend').html('修改资金量');
    	}
    ...
    function saveOrUpdate(){
	  ...
	  var _params = $('#formId').serialize();
   	  ...
   	  var _postUrl = '/fundstypes/saveOrUpdate.do';
   ...
   function deletes(){
	   ...
	   showConfirm('确认要删除'+rowDatas.length+'条数据吗？',
		function(){
		   ...
		   $.post(path + '/fundstypes/delete.do',{ids:_delIdArr.toString()},function(_backData){
			   if("success" == _backData){
				   showOnlyMsg('删除成功！');
	   	  	   }else
			        ...
			        <form class="form-inline" id="formId">
					    ...
					    <fieldset>
					      ...
					      <div class="form-group">
						    ...
						    <input type="text" class="form-control" name="founds_name" id="nameInput" placeholder="名称" data-toggle="tooltip" data-placement="top" title="请输入资金量名称！">
						  </div>
