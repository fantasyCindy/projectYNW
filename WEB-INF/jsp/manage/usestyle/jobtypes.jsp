  ...
  <script>
    ...
    function saveOrUpdate(){
	  ...
	  var _params = $('#formId').serialize();
   	  ...
   	  var _postUrl = '/jobtypes/saveOrUpdate.do';
   ...
   function deletes(){
	   ...
	   showConfirm('确认要删除'+rowDatas.length+'条数据吗？',
		function(){
		   ...
		   $.post(path + '/jobtypes/delete.do',{ids:_delIdArr.toString()},function(_backData){
			   if("success" == _backData){
				   showOnlyMsg('删除成功！');
	   	  	   }else
			        ...
			        <form class="form-inline" id="formId">
					    ...
					    <fieldset>
					      ...
					      <div class="form-group">
						    ...
						    <input type="text" class="form-control" name="job_name" id="nameInput" placeholder="名称" data-toggle="tooltip" data-placement="top" title="请输入资金量名称！">
						  </div>
