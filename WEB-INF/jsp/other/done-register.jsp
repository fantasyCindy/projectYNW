        ...
        <%@ include file="../common/front-head.jsp" %>
            <div id="done-refer">
                ...
                <div class="content">
                    ...
                    <div class="txt phone">手机号：<span class="colorRed user">18310372520</span></div>
                    <div class="txt">您可以用<strong>手机号</strong>进行登录</div>
                    <div class="time">倒计时<span class="colorBlue"><span class="count">3</span>S</span><a class="link" href="http://www.yuetougu.com/">跳过></a></div>
                </div>
            </div>
