...
<body>
    ...
    <div id="zhaopin">
        <h1 class="title"><p class="tc">招贤纳士<br><font>Join us</font></p></h1>
        ...
        <div class="map"><span><i class="fa fa-map-marker"></i>工作地点：北京</span><span><i class="fa fa-envelope"></i>邮箱3001716958@qq.com(邮件标题请注明应聘职位)</span></div>
    </div>
