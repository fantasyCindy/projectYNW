<%@ page language="java" import="java.util.*" pageEncoding="UTF-8"%>
 ...
 %>
        <div id="contentart">
                ...
                <div id="login">
                    ...
                    <div class="act activity-refer" style="overflow: hidden;">
                        <a onclick="activity.render()" style="display: inline-block;width:100%">
                            <img style="width:100%;" src="/public/v2/index/images/ditu.png?333" alt=""></a>
                        </div>
                </div>
        ...
        var ynTeacherId, ynIsLogin, ynIsTeacher, ynUserId, ynTeacherName, ynUserName,flag
        try{
            ...
            flag = '${login_user_front.is_inside}';
        }catch(e){}
        /* beautify ignore:end */
        </script>
