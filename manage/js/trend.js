var Trend_Url=js_lib.getTrendUrl();
//http://open.hundsun.com:8081/quote/v1/trend?prod_code=600570.SS&fields=last_px,business_amount,avg_px
var Real_Url=js_lib.getCommonRealUrl();
//http://open.hundsun.com:8081/quote/v1/real?en_prod_code=600570.SS&fields=open_px,preclose_px
var DIVID='#line_map';
//接收个股代码
var STOCK_CODE = js_lib.getQueryStringByName("stock_code");
/*
 * 分时
 */
if(STOCK_CODE==""){
...
function callbackReal(val){
    var jsonText = JSON.parse(val);    
    var price_data=jsonText.data.snapshot;
