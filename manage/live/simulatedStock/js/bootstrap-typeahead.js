...
!function($) {
	...
	/*
	 * TYPEAHEAD PUBLIC CLASS DEFINITION 26 * =================================
	 */
	...
	Typeahead.prototype = {
		...
		sorter : function(items) {
			...
			while (item = items.shift()) {
				...
				var myPropVal = this.propName == "" ? item
						: item[this.propName];
		...
		highlighter : function(item) {
			...
			var query = this.query.replace(/[\-\[\]{}()*+?.,\\\^$|#\s]/g,
					'\\$&')
			return myPropVal.replace(new RegExp('(' + query + ')', 'ig'),
					function($1, match) {
	...
	/*
	 * TYPEAHEAD PLUGIN DEFINITION 300 * ===========================
	 */
