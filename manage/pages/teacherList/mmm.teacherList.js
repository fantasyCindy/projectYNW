...
/***/ (function(module, exports, __webpack_require__) {
	...
	new Vue({
	    ...
	    methods: {
	        up: function () {
	            var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(item, index) {
	                var self;
	        ...
	        down: function () {
	            var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(item, index) {
	                var self;
	        ...
	        render: function render() {
	            ...
	            $.getJSON(url, send, function (back) {
	                if (back.status != 1) {
	                    return _this.$message.error(back.status);
	                }
	                _this.list = back.data;
	            });
	        }
	    },
	...
	var sortNumTeacher = function sortNumTeacher(params) {
	    return new _promise2.default(function (resolve) {
	        $.post("/teacher/sortNoTeacher.do", params, function (back) {
	            return resolve(back);
	        });
	    });
	};
