...
/***/ (function(module, exports, __webpack_require__) {
	...
	var HandleData = __webpack_require__(15).handleData;
	    ...
	    return {
	        init: function init() {
	            ...
	            $('.askWin-trigger').click(function () {
	                ...
	                askWindow.render({
	                    select: { id: room_teacherid, name: $('#teacher-nickName').text() }
	                });
	            });
	        }
	    };
	...
	var menu = function () {
	    ...
	    function light() {
	        if (container.next().find('.askStock-category-item').length != 0) {
	            container.find('.item').eq(2).addClass('select');
	        }
	        if (container.next().find('.opinionType-item').length != 0) {
	            container.find('.item').eq(3).addClass('select');
	        }
	    }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var queryStock = __webpack_require__(7);
	var stockList = __webpack_require__(8);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	*/
	...
	var local = __webpack_require__(11);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	*/
	...
	var struct_status = [[0, "预售中"], [1, "进行中"], [2, "已结束"]];

	var struct_style = [[0, "保守型"], [1, "稳健性"], [2, "激进型"]];

	var buttonTable = {
	    end: function end(ops) {
	        return "<a " + ops.link + " class=\"ynbtn toFeed done\" data-type=\"done\">\u5DF2\u7ED3\u675F</a>";
	    },
	    feed: function feed(ops) {
	        return "<a " + ops.link + " class=\"ynbtn toFeed\">\u8BA2\u9605</a>";
	    },
	    feeded: function feeded(ops) {
	        return "<a class=\"ynbtn\" data-type=\"feeded\">\u5DF2\u8BA2\u9605</a>";
	    },
	    look: function look(ops) {
	        return "<a " + ops.link + " class=\"ynbtn toFeed\">\u67E5\u770B\u8BE6\u60C5</a>";
	    },
	    peep: function peep(ops) {
	        return "<a " + ops.link + " class=\"ynbtn toFeed\" data-type=\"peep\">" + ops.peepText + "\u7784\u4E00\u773C</a>";
	    },
	    bottom: function bottom(ops) {
	        return "<a " + ops.link + " class=\"ynbtn toFeed\" data-type=\"bottom\">\u5DF2\u7ED3\u675F</a>";
	    }
	};

	var countTable = [function (ops) {
	    return "<strong>" + (ops.count - 1) + "</strong>\u5929\u540E\u8FD0\u884C";
	}, function (ops) {
	    return "\u5DF2\u7ECF\u8FD0\u884C<strong>" + ops.count + "</strong>\u5929";
	}, function (ops) {
	    return "\u5171\u8FD0\u884C<strong>" + ops.runCount + "</strong>\u5929";
	}];

	var handleData = function handleData(data, source) {
	    ...
	    return _.map(data, function (item) {
	        ...
	        //计算订阅状态
	        item._feed = function () {
	            var query = [{ key: 'end', assert: status >= 2 }, //已结束
	            ...
	            var keys = _.filter(query, function (item) {
	                return item.assert;
	            });
