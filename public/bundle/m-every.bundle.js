...
/***/ function(module, exports, __webpack_require__) {
	...
	window.m_config = {
	    ...
	    livelist: [{ path: 'rqhot', name: '人气最高', index: '0' }, { path: 'gdhot', name: '观点最多', index: '1' }, { path: 'hdhot', name: '互动最多', index: '2' }],
	    none: function none(ops) {
	        ops = $.extend({
	            text: "暂无记录",
	            margin: 260,
	            fontSize: 14
	        }, ops);
	        return "<p class='nothing' style='background:white;text-align:center;padding:" + ops.margin + "px 0;font-size:" + ops.fontSize + "px'>" + "<i class='fa fa-exclamation-circle fa-lg' style='margin-right:5px'></i>" + ops.text + "</p>";
	    },
	    more: function more() {
	        return '<p class="loadMore">加载更多</p>';
	    },
	    link: function link(path, paths) {
	        var param = {
	            name: null,
	            index: 0
	        };
	...
	m.navigation = function () {
	    ...
	    var getName = function getName(path) {
	        var paths = [{ key: "m-ask", name: "问股" }, { key: "m-live", name: "直播" }, { key: "m-opinion", name: "观点" }, { key: "m-refer", name: "内参" }];
	        var name = "";
	        paths.forEach(function (item) {
