<template>
	<div class="orderList">
		<div class="list-title">订单列表  <span class="totalprice">总价<span v-html="totalPrice" class="totalPrice"></span>元</span></div>
		<div class="option">
		...
		<div class="option">
			邀请码<input type="text" v-model="employeeCode">
		</div>
		<div class="option">
			<el-form label-width="80px" :inline="true" style="width：400px">
...
alert(123)
	...
	export default {
		...
		methods: {
			...
			query() {
				console.log('send',this.send.startTime)
