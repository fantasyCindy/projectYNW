...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getAskTimes = function getAskTimes() {
	    var defer = $.Deferred();
	...
	//用户提问  未回答
	var noAnswer = function noAnswer(ops) {
	    ops = _.extend({
	        page: 1,
	        row: 10,
	        isReply: 0
	...
	//用户提问  已回答
	var yesAnswer = function yesAnswer(ops) {
	    ops = _.extend({
	        page: 1,
	        row: 10
	    }, ops);
	...
	//用户提问  待评价
	var evalAnswer = function evalAnswer(ops) {
	    ops = _.extend({
	        page: 1,
	        row: 10
	    }, ops);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var PayModule = __webpack_require__(10); //支付模块  pay-confirm-v1.2.js   pay-any.js'
	var Path = __webpack_require__(17);
	__webpack_require__(18);
	var queryStock = __webpack_require__(20);
	var stockList = __webpack_require__(21);
	var error = __webpack_require__(3);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var payAny = __webpack_require__(11);
	var payConfirm = __webpack_require__(13);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ErrorCode = __webpack_require__(16);
